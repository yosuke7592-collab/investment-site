...
const services: Service[] = [
  ...
  { category: "broker", name: "松井証券", purpose: "NISA、日本株・米国株、投資信託の利用", features: ["NISA", "日本株・米国株", "投資信託・FX"], caution: "商品ごとに取引画面やアプリ、手数料体系が異なる場合がある。", url: "https://www.matsui.co.jp/nisa/", label: "公式サイトを見る", brokerDetails: { costs: "商品・年齢・取引金額等による手数料条件、投資信託の信託報酬、為替関連費用を確認。", usability: "利用する商品に対応する画面・アプリ、相談・サポート方法を確認。", unsuitable: "複数商品を一つの同じ操作画面だけで完結させたい人。", checkedAt: "2026年9月6日", sourceUrl: "https://www.matsui.co.jp/", sourceLabel: "松井証券 公式サイト" } },
