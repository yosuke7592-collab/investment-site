...
export default function MechanicsPage(){return <main className="mechanics-page">
  ...
  <section className="mechanics-hero"><p className="eyebrow">HOW FINANCIAL TRADING WORKS</p><h1>商品を選ぶ前に、<br/><em>取引の裏側</em>を知る。</h1><p>金融商品は名前だけ覚えても使えません。誰と取引し、価格はどう決まり、お金と商品がどう動き、どこまで損をする可能性があるのか。この共通構造から理解します。</p></section>
  ...
  <section className="mechanics-section" id="market"><header><span>01</span><div><p className="eyebrow">MARKET &amp; EXECUTION</p><h2>売りたい人と買いたい人が、<br/>同じ条件で出会う。</h2></div></header><div className="mechanics-copy">
  ...
  <section className="mechanics-section alt" id="spot"><header><span>02</span><div><p className="eyebrow">SPOT &amp; STOCKS</p><h2>現物取引は、代金を払い、<br/>実際に保有する。</h2></div></header><div className="mechanics-copy">
  ...
  <section className="mechanics-section" id="funds"><header><span>03</span><div><p className="eyebrow">FUNDS &amp; ETF</p><h2>投資信託とETFは、<br/>中身は近く、買い方が違う。</h2></div></header><div className="mechanics-copy">
  ...
  <section className="mechanics-section alt" id="derivatives"><header><span>04</span><div><p className="eyebrow">BORROWING &amp; DERIVATIVES</p><h2>「借りる」と「差額を取引する」を<br/>同じにしない。</h2></div></header><div className="mechanics-copy">
