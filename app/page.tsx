...
export default function Home() {
  ...
  return <main>
    <header className="topbar site-header"><a className="brand" href="#top"><span className="brand-mark">18</span><span>投資の地図</span></a><nav className="global-nav" aria-label="メインナビゲーション"><a href="/courses">2つのコース</a><a href="/strategies">データ・戦略</a><a href="/services">サービス比較</a></nav><div className="progress-mini"><span>{progress}%</span><div><i style={{ width: `${progress}%` }} /></div></div></header>
    <section className="hero" id="top"><div className="hero-copy"><p className="eyebrow">20 LESSONS + TRADING LAB</p><h1>未来のお金を、<br/><em>自分で考える力</em>を。</h1><p className="lead">基礎を知るだけで終わらない。商品を比べ、取引画面を読み、注文と損益を練習してから、自分のルールで最初の少額投資へ進みます。</p><div className="hero-actions"><button className="primary" onClick={() => document.getElementById("curriculum")?.scrollIntoView({behavior:"smooth"})}>基礎から学ぶ <span>→</span></button><a className="secondary" href="/courses">2つのコースを選ぶ</a></div></div><div className="hero-orbit" aria-hidden="true"><div className="orbit"/><div className="orbit orbit-two"/><div className="coin"><span>¥</span></div><span className="orbit-label label-a">THINK</span><span className="orbit-label label-b">LEARN</span><span className="orbit-label label-c">DECIDE</span></div></section>
    <section className="quick-gateway" aria-label="主要コンテンツ"><p className="eyebrow">START HERE</p><div><a className="gateway-primary" href="/courses"><span>01</span><b>2つのコースを選ぶ</b><small>長期資産形成／アクティブ投資</small></a><a href="/strategies"><span>02</span><b>データ・戦略ラボ</b><small>ローソク足と売買ルールを学ぶ</small></a><a href="/services"><span>03</span><b>サービス比較</b><small>証券会社・デモ・参考書を比べる</small></a></div></section>
