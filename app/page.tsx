...
export default function Home() {
  ...
  return <main>
    ...
    <section className="hero" id="top"><div className="hero-copy"><p className="eyebrow">20 LESSONS + TRADING LAB</p><h1>未来のお金を、<br/><em>自分で考える力</em>を。</h1><p className="lead">基礎を知るだけで終わらない。商品を比べ、取引画面を読み、注文と損益を練習してから、自分のルールで最初の少額投資へ進みます。</p><div className="hero-actions"><button className="primary" onClick={() => document.getElementById("curriculum")?.scrollIntoView({behavior:"smooth"})}>学習の地図を見る <span>→</span></button><a className="secondary" href="/lab">商品・取引ラボへ</a></div></div><div className="hero-orbit" aria-hidden="true"><div className="orbit"/><div className="orbit orbit-two"/><div className="coin"><span>¥</span></div><span className="orbit-label label-a">THINK</span><span className="orbit-label label-b">LEARN</span><span className="orbit-label label-c">DECIDE</span></div></section>
    ...
    <section className="lab-entry"><p className="eyebrow">PRODUCT &amp; TRADING LAB</p><h2>知識を、画面の操作へ。</h2><p>投資商品の違いを比べ、一般的な取引画面を読み、仮の注文と損益を体験します。</p><a href="/lab">商品・取引ラボを開く <span>→</span></a></section>
