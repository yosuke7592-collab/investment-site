    ...
    <main className="start-page">
      ...
      <article className="start-article">
        ...
        <section className="emotion-loop" aria-labelledby="loop-title">
          ...
          <h2 id="loop-title">ルールを破った成功が、次の失敗をつくる</h2>
