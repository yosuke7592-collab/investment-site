...
export default function LabPage() {
  ...
  return <main className="lab-page">
    ...
    <section className="lab-hero"><p className="eyebrow">COURSE B · ACTIVE INVESTING</p><h1>選ぶ。見る。<br/><em>動かして理解する。</em></h1><p>企業・チャート・出来高を分析し、自分の売買ルールを作って検証するコースです。ここで動く金額はすべて練習用です。</p><nav><a href="#products">1 商品を選ぶ</a><a href="#screen">2 画面を読む</a><a href="#simulator">3 注文を試す</a></nav></section>
